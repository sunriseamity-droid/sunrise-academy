...
const services = [
  ...
  },
  {
    ...
    text: "Choose courses that match your interests, strengths and long-term career goals.",
  },
  {
    icon: "📝",
    title: "Application Assistance",
    text: "Assistance with forms, documents and important admission requirements.",
  },
  {
    icon: "🤝",
    title: "Personal Counselling",
    text: "One-to-one counselling to help students and parents make confident education decisions.",
  },
];
...
const programs = [
  ...
  ["🎙️", "BA (JMC)", "Bachelor of Arts in Journalism & Mass Communication"],
...
export default function Home() {
  ...
  course selection and complete admission support.
      ...
      {/* UNIVERSITY PROGRAMS */}
      <section id="university" className="bg-white px-6 py-20">
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            <p className="font-bold uppercase tracking-widest text-yellow-500">
              University Programs
            ...
            <h2 className="mt-2 text-4xl font-extrabold text-[#061a3a] md:text-5xl">
              Choose Your University Program
            </h2>

            <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-slate-600">
              Explore undergraduate and postgraduate programs with expert
              admission guidance from Sunrise Academy.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {programs.map(([icon, title, description]) => (
              ...
              >
                <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-yellow-400 text-2xl">
                  {icon}
                </div>

                <h3 className="mt-6 text-2xl font-bold text-[#061a3a]">
                  {title}
                </h3>
                ...
                <a
                  href="#booking"
                  className="mt-5 inline-block font-bold text-blue-700 hover:text-yellow-500"
                >
                  Enquire Now →
                </a>
              </div>
    ...
    <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-slate-600">
              Explore our campus visits, counselling sessions, educational
              events and student guidance activities.
            </p>
          </div>

          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {gallery.map(([emoji, title]) => (
              <div
                key={title}
      ...
      <section id="booking" className="bg-white px-6 py-20">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-slate-600">
            Get personalised admission guidance from our experienced education
            consultants and take the next step toward your academic future.
          </p>
          ...
          <div className="mx-auto mt-10 max-w-2xl text-left">
            ...
            >
              <div>
                <label
                  htmlFor="name"
                  className="mb-2 block font-semibold text-[#061a3a]"
                >
                  Name
                </label>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-300 px-4 py-3 outline-none focus:border-yellow-400 focus:ring-1 focus:ring-yellow-400"
                  required
                />
              </div>
              ...
              <button
                ...
                className="w-full rounded-lg bg-yellow-400 px-6 py-4 font-bold text-[#061a3a] transition hover:bg-yellow-500 disabled:cursor-not-allowed disabled:opacity-60"
              >
        ...
        <div className="mx-auto max-w-6xl text-center">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            ...
            <a
              ...
              className="rounded-lg border-2 border-white bg-white px-7 py-4 font-bold text-[#061a3a] transition hover:bg-yellow-400"
            >
              ✉️ Email Us
            </a>
          </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-3">
          ...
          <div>
            ...
            <div className="mt-4 space-y-2">
              ...
              <a className="block hover:text-yellow-400" href="#university">
                University Programs
              </a>

              <a className="block hover:text-yellow-400" href="#gallery">
                Gallery
              </a>

              <a className="block hover:text-yellow-400" href="#booking">
                Booking
              </a>
